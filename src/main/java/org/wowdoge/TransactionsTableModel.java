    ...
    public void setValue(Object aValue) {
        ...
        if (aValue != null) {
        	...
        	if (aValue instanceof TransactionConfidence) {
        		...
        		setText(Coin.valueOf(value.longValue()).toFriendlyString()); //bitcoinValueToFriendlyString
        	} else
...
class TransactionsTableModel extends AbstractTableModel {
        ...
        public String getTransactionString(int index) {
        	String temp = "";
        	for (int i = 0; i < getColumnCount(); i++) {
        		temp = temp + getColumnName(i) + ": " + getValueAt(index, i);
        		temp = temp + "\n";
        	}
        	return temp;
        }
...
//        }
		...
		public Object getValueAt(int row, int col) {
        	...
        	if (row < transactions.size()) {
        		...
        		switch (col) {
        		case 0:
        			if (t.getValue(wallet).compareTo(Coin.ZERO) < 0)
        				return "SENT";
        			else
        				return "RECEIVED";
        		case 1:
        		...
        		case 2:
        			if (wallet != null)
        				return t.getValue(wallet).toPlainString(); //new Float(bitcoinValueToFriendlyString(
        			else
        				return "";
        		case 3:
        		...
        		case 5:
        			...
        			for (TransactionInput i : ins) {
        				try {
        					...
        					if (output != null)
        						tempText = tempText + output.getValue().toPlainString() + " " + Version.coinNameWithSpace + i.getFromAddress().toString() + " "; //Utils.bitcoinValueToFriendlyString(
        					else
        		...
        		case 6:
        			...
        			for (TransactionOutput o : outs) {
        				tempText1 = tempText1 + o.getValue().toPlainString() + " " + Version.coinNameWithSpace + o.getScriptPubKey().getToAddress(o.getParams()).toString() + " "; //Utils.bitcoinValueToFriendlyString( //toString()
        				//System.out.println(i.getFromAddress());
        			}
        ...
        public Color getRowColour(int row) {
        	Transaction t = transactions.get(row);
        	if (t.getValue(wallet).compareTo(Coin.ZERO) < 0) //BigInteger.ZERO
        		return red;
        	else
        		return green;
        }
